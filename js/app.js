// const API = 'https://backend-masteringdb.onrender.com/mastering'
const API = 'https://darwin-tasmanian-devil-ddzh.2.sg-1.fl0.io/mastering'
...
function popupPortadas(img, artista, nombreLanzamiento, discoTipo, fechaLanzamiento, linkSpotify) {
    ...
    artistaElement.innerHTML = `<span>Artista: </span>${artista}`;
    ...
    nombreLanzamientoElement.innerHTML = `<span>Lanzamiento: </span>${nombreLanzamiento} (${discoTipo})`;
    ...
    fechaLanzamientoElement.innerHTML = `<span>Año: </span>${fechaLanzamiento}`;
...
// const botones = document.querySelectorAll('.btn-flechas')
